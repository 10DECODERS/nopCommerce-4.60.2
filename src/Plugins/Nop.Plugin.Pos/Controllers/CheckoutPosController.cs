...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutPosController : BasePublicController
    {
        #region Fields
        ...
        public CheckoutPosController(AddressSettings addressSettings,
        ...
        public virtual async Task<IActionResult> Index()
        {
            ...
            if (_orderSettings.OnePageCheckoutEnabled)
                return RedirectToRoute("CheckoutOnePagePos");
...
                order = await _orderService.GetOrderByIdAsync(orderId.Value);
        ...
        public virtual async Task<IActionResult> DeleteEditShippingAddress(int addressId, bool opc = false)
        {
            return await DeleteAddressAsync(addressId, async (cart) =>
            {
                ...
                return Json(new
                {
                    ...
                    {
                        name = "shipping",
                        html = await RenderPartialViewToStringAsync("~/Plugins/Pos/Views/CheckoutPos/OpcBillingAddress.cshtml", shippingAddressModel)
                    }
                });
            });
        }
        ...
        public virtual async Task<IActionResult> SaveEditShippingAddress(CheckoutShippingAddressModel model, IFormCollection form, bool opc = false)
        {
            return await EditAddressAsync(model.ShippingNewAddress, form, async (customer, cart, address) =>
            {
                ...
                if (!opc)
                    return Json(new
                    {
                        redirect = Url.RouteUrl("CheckoutShippingAddressPos")
                    });
        ...
        public virtual async Task<IActionResult> BillingAddress(IFormCollection form)
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/BillingAddress.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> ShippingAddress()
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/ShippingAddress.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> ShippingMethod()
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/ShippingMethod.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> PaymentMethod()
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/PaymentMethod.cshtml", paymentMethodModel);
        }
        ...
        public virtual async Task<IActionResult> PaymentInfo()
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/PaymentInfo.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> Confirm()
        {
            ...
            return View("~/Plugins/Pos/Views/CheckoutPos/Confirm.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> ConfirmOrder(bool captchaValid)
        {
            ...
            if (!cart.Any())
                return RedirectToRoute("ShopPlugin.Pos.NeworderpingCart");
            ...
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    ...
                    return RedirectToRoute("CheckoutCompletedPos", new { orderId = placeOrderResult.PlacedOrder.Id });
                }
        ...
        protected virtual async Task<JsonResult> OpcLoadStepAfterShippingAddress(IList<ShoppingCartItem> cart)
        {
            ...
            return Json(new
            {
                update_section = new UpdateSectionJsonModel
                {
                    ...
                    html = await RenderPartialViewToStringAsync("~/Plugins/Pos/Views/CheckoutPos/OpcShippingMethods.cshtml", shippingMethodModel)
                },
        ...
        protected virtual async Task<JsonResult> OpcLoadStepAfterShippingMethod(IList<ShoppingCartItem> cart)
        {
            ...
            if (isPaymentWorkflowRequired)
            {
                ...
                return Json(new
                {
                    ...
                    {
                        name = "payment-method",
                        html = await RenderPartialViewToStringAsync("~/Plugins/Pos/Views/CheckoutPos/OpcPaymentMethods.cshtml", paymentMethodModel)
                    },
        ...
        public virtual async Task<IActionResult> OnePageCheckout(Address address = null)
        {
            ...
            //{
            //    model.BillingAddress.BillingNewAddress.FirstName = address.FirstName;
            //    model.BillingAddress.BillingNewAddress.LastName = address.LastName;
            //    model.BillingAddress.BillingNewAddress.Email = address.Email;
            //    model.BillingAddress.BillingNewAddress.CountryId = address.CountryId;
            //    model.BillingAddress.BillingNewAddress.StateProvinceId = address.StateProvinceId;
            //    model.BillingAddress.BillingNewAddress.PhoneNumber = address.PhoneNumber;
            //}
            // ViewBag.Country = false;


            return View("~/Plugins/Pos/Views/CheckoutPos/OnePageCheckout.cshtml", model);
        }
        ...
        public virtual async Task<IActionResult> OpcSaveBilling(CheckoutBillingAddressModel model, IFormCollection form)
        {
            try
            {
                ...
                if (customer1 == null)
                {
                    ...
                    customer1.CreatedBy = customer.Email;
                    customer1.Username = getcustomer.Email;
                    customer1.Email = getcustomer.Email;
                    customer1.FirstName = getcustomer.FirstName;
                    customer1.LastName = getcustomer.LastName;
                    customer1.Phone = getcustomer.PhoneNumber;
                    customer1.City = getcustomer.City;
                    if (cou != null)
                    {
                ...
                {
                    //existing address
                    var address = await _customerService.GetCustomerAddressAsync(customer1.Id, billingAddressId)
                ...
                if (await _shoppingCartService.ShoppingCartRequiresShippingAsync(cart))
                {
                    ...
                    var address = await _customerService.GetCustomerBillingAddressAsync(customer1);
                    ...
                    {
                        //ship to the same address
                        customer1.ShippingAddressId = address.Id;
                        await _customerService.UpdateCustomerAsync(customer1);
                        //reset selected shipping method (in case if "pick up in store" was selected)
            ...
            {
                await _logger.WarningAsync("checkpoint 1", exc, await _workContext.GetCurrentCustomerAsync());
                await _logger.WarningAsync(exc.Message, exc, await _workContext.GetCurrentCustomerAsync());
                return Json(new { error = 1, message = exc.Message });
            }
        }
        ...
        public virtual async Task<IActionResult> OpcCompleteRedirectionPayment()
        {
            try
            {
                ...
                return RedirectToRoute("CheckoutCompletedPos", new { orderId = order.Id });
            }
            catch (Exception exc)
            {
                await _logger.WarningAsync(exc.Message, exc, await _workContext.GetCurrentCustomerAsync());
        ...
        public virtual async Task<Customer> GetCustomerDetails(string Phonenumber)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> GetCustomerDetailss(string Phonenumber)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(Phonenumber))
                    return NoContent();
                var address = new PosAddressModel();
                ...
                {
                    var state = await _stateProvinceRepository.GetByIdAsync(address.posaddress.StateProvinceId);

                    address.Country = billingcountry.Name;
        ...
        public virtual async Task<Customer> GetCustomerByPhoneNumberAsync(string Phonenumber)
        {
            ...
            try
            {
                ...
                var query = from a in _customerRepository.Table

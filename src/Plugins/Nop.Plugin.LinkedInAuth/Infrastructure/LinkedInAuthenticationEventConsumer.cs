...
namespace Nop.Plugin.LinkedInAuth.Infrastructure
{
    ...
    /// </summary>
    public class LinkedInAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public LinkedInAuthenticationEventConsumer(ICustomerService customerService)
        {
        ...
        public async Task HandleEventAsync(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            //if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(LinkedInAuthenticationDefaults.SystemName))
            //    return;
